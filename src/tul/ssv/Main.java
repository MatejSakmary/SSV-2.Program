...
public class Main extends JFrame {
    ...
    public Main() throws HeadlessException {
        ...
        */
        ...
        /*r[ np ] = 50;
        color[ np++ ] = Color.yellow;
        
        rkt.addPlanet( 3.3e23,    5.791e10,  48e3  );
        r[ np ] = 10;
        color[ np++ ] = Color.orange;
        
        rkt.addPlanet( 4.87e24,   1.082e11,  35e3  );
        r[ np ] = 20;
        color[ np++ ] = Color.gray;
        
        rkt.addPlanet( 5.97e24,   1.496e11,  30e3  );
        r[ np ] = 25;
        color[ np++ ] = Color.blue;
        
        rkt.addPlanet( 6.42e23,   2.2794e11, 24e3  );
        r[ np ] = 25;
        color[ np++ ] = Color.red;
        
        rkt.addPlanet( 1.9e27,    7.7833e11, 5.3e3 );
*/
